...
export const addEmployee = async (req, res) => {
  try {
    ...
    // Pub/Sub notification for new employee added
    await redisClient.publish('employee-events', JSON.stringify({
      type: 'created',
      data: newEmployee,
    }));
...
export const updateEmployee = async (req, res) => {
  try {
    ...
    // Pub/Sub notification for employee updated
    await redisClient.publish('employee-events', JSON.stringify({
      type: 'updated',
...
export const deleteEmployee = async (req, res) => {
  try {
    ...
    // Pub/Sub notification for employee deleted
    await redisClient.publish('employee-events', JSON.stringify({
      type: 'deleted',
